...
export function DeleteButton({ id, type }: { id: string; type: "project" | "post" | "skill" | "experience" }) {
  const [isDeleting, setIsDeleting] = useState(false)
  const router = useRouter()
  
  const tableName = type === "project" ? "projects" : type === "post" ? "blog_posts" : type === "skill" ? "skills" : "experiences"
